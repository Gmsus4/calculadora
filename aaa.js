...
const eCodes = [
    'Digit0', 'Numpad0', 'Digit1', 'Digit2', 'Digit3', 'Digit4', 'Digit5', 'Digit6', 'Digit7', 'Digit8', 'Digit9',
    'Period', 'Numpad1', 'Numpad2', 'Numpad3', 'Numpad4', 'Numpad5', 'Numpad6', 'Numpad7', 'Numpad8', 'Numpad9',
    'NumpadDecimal'
]

const eCodesFunctions = [
    'Escape', 'Backspace', 'NumpadEnter', 'NumpadAdd', 'NumpadDivide', 'NumpadMultiply', 'NumpadSubtract'
]
...
const numpadEnterFunction = () => {
    const num = (num) => {
        const opertation = parseFloat(display.textContent) + parseFloat(newSpan.textContent);
        display2.innerHTML = `${display.innerText}` + `${operadores[num].innerHTML}` + `${newSpan.textContent}`;
        display.innerHTML = `${operadores[num].innerHTML}`;
        display.innerHTML += opertation;
    }
    ...
    if(display.textContent === '3861112341' && display2.textContent === '0'){
        ...
        switch (oper){
            case 1: num(6, plus); break;
             case 2: num(5, resta); break;
             case 3: num(4, addM); break;
             case 4: num(3, addM); break;
        }
    } else{
